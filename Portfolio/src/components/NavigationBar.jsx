...
function NavigationBar() {
  ...
  return (
    <>
      <nav className="fixed top-0 left-1/2 transform -translate-x-1/2 z-50 w-auto max-w-xs sm:max-w-xs md:max-w-sm lg:max-w-sm glass rounded-2xl mt-2 sm:mt-4 shadow-lg shadow-indigo-500/10">
        <div className="px-3 sm:px-4 md:px-6">
          <div className="flex justify-center items-center py-3 sm:py-4">
            <div className="flex space-x-4 sm:space-x-5 md:space-x-6">
              <button
                onClick={scrollToTop}
                className="nav-link text-gray-700 hover:text-indigo-600 transition-all duration-300 p-2 rounded-xl hover:bg-indigo-50/50"
              >
