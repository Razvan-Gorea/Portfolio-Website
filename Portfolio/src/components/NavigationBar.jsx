...
function NavigationBar() {
  return (
    <>
      <nav className="fixed top-0 left-1/2 transform -translate-x-1/2 z-50 w-auto max-w-xs sm:max-w-xs md:max-w-sm lg:max-w-sm bg-white shadow-md rounded-xl mt-2 sm:mt-4">
